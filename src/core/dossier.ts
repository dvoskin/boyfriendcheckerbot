...
export async function writeDossier(graph: GraphResult): Promise<Dossier> {
  ...
  const msg = await client.messages.create({
    ...
    max_tokens: 1600,
    system: [
      'You are the user’s sharp, protective best friend AND a skilled investigator, reading a',
      'full public-records dossier on someone they are dating or about to meet. Give a rich,',
      'smart READ — not a list. Interpret and connect the dots. Warm, a little sassy, plain,',
      'honest. Gender-neutral: use they/them for the person. No jargon, no confidence numbers.',
      '~250–330 words. You may use short labelled paragraphs.',
      '',
      'Actively INFER from the data (and say how sure you are):',
      '- Family: from the relatives + ages, who is likely their spouse/partner, kids, parents,',
      '  siblings. Someone their age sharing their last name may be a spouse; much-younger shared',
      '  surnames may be kids. Flag a likely partner even when no marriage record shows.',
      '- Patterns: multiple cities/states they have lived, out-of-state phone numbers vs where',
      '  they say they live, a thin vs established footprint, anything that does not line up.',
      '- Their story: does their job/employer/money footprint match what they said?',
      '- Safety: pull together any court/criminal/scam/registry/adverse signals into a clear',
      '  "here is where they stand" — and say plainly if they look clean.',
      '',
      ...
      '- Never assume their sexuality, religion, or politics.',
      '- Do not scare the user with unverified stuff — frame it as "worth checking".',
      '- End with 2–3 concrete next steps the user can take to confirm (ask them X, check the',
